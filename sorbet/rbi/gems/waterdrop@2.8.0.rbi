...
#
# source://waterdrop//lib/waterdrop/errors.rb#69
WaterDrop::AbortTransaction = WaterDrop::Errors::AbortTransaction
...
class WaterDrop::Errors::EarlyTransactionExitNotAllowedError < ::WaterDrop::Errors::BaseError; end
...
#
# source://waterdrop//lib/waterdrop/errors.rb#54
class WaterDrop::Errors::ProduceManyError < ::WaterDrop::Errors::ProduceError
  ...
  #
  # source://waterdrop//lib/waterdrop/errors.rb#60
  def initialize(dispatched, message); end

  # Returns the value of attribute dispatched.
  #
  # source://waterdrop//lib/waterdrop/errors.rb#55
  def dispatched; end
end
...
class WaterDrop::Instrumentation::LoggerListener
  ...
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#97
  def on_buffer_flushed_async(event); end

  # @param event [Dry::Events::Event] event that happened with the details
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#108
  def on_buffer_flushed_sync(event); end

  # @param event [Dry::Events::Event] event that happened with the details
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#119
  ...
  # @param event [Dry::Events::Event] event that happened with the details
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#75
  ...
  # @param event [Dry::Events::Event] event that happened with the details
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#86
  ...
  # @param event [Dry::Events::Event] event that happened with the details
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#63
  ...
  # @param event [Dry::Events::Event] event that happened with the details
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#131
  def on_producer_closed(event); end

  # @param event [Dry::Events::Event] event that happened with the details
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#124
  def on_producer_closing(event); end

  # @param event [Dry::Events::Event] event that happened with the details
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#136
  def on_producer_reloaded(event); end

  # @param event [Dry::Events::Event] event that happened with the details
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#154
  def on_transaction_aborted(event); end

  # @param event [Dry::Events::Event] event that happened with the details
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#159
  def on_transaction_committed(event); end

  # @param event [Dry::Events::Event] event that happened with the details
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#178
  def on_transaction_finished(event); end

  # @param event [Dry::Events::Event] event that happened with the details
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#164
  def on_transaction_marked_as_consumed(event); end

  # @param event [Dry::Events::Event] event that happened with the details
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#149
  ...
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#191
  def debug(event, log_message); end

  # @param event [Dry::Events::Event] event that happened with the details
  # @param log_message [String] message we want to publish
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#207
  def error(event, log_message); end

  # @param event [Dry::Events::Event] event that happened with the details
  # @param log_message [String] message we want to publish
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#197
  def info(event, log_message); end

  # @return [Boolean] should we report the messages details in the debug mode.
  #
  # source://waterdrop//lib/waterdrop/instrumentation/logger_listener.rb#185
...
class WaterDrop::Producer
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#46
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#83
  def client; end
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#165
  def idempotent?; end

  # @return [Array] internal messages buffer
  #
  # source://waterdrop//lib/waterdrop/producer.rb#37
  def messages; end
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#175
  def middleware; end

  # @return [Object] monitor we want to use
  #
  # source://waterdrop//lib/waterdrop/producer.rb#39
  def monitor; end
  ...
  #   retrieved.
  #
  # source://waterdrop//lib/waterdrop/producer.rb#128
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#137
  def purge; end
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#63
  def setup(&block); end
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#156
  ...
  #   a default one.
  #
  # source://waterdrop//lib/waterdrop/producer.rb#290
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#298
  def produce(message); end
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#280
  def wait(handler, raise_response_error: T.unsafe(nil)); end
end
...
#
# source://waterdrop//lib/waterdrop/producer.rb#26
WaterDrop::Producer::EMPTY_ARRAY = T.let(T.unsafe(nil), Array)

# Empty hash to save on memory allocations
#
# source://waterdrop//lib/waterdrop/producer.rb#23
WaterDrop::Producer::EMPTY_HASH = T.let(T.unsafe(nil), Hash)

# Which of the inline flow errors do we want to intercept and re-bind
#
# source://waterdrop//lib/waterdrop/producer.rb#17
...
module WaterDrop::Producer::Transactions
  ...
  #
  # source://waterdrop//lib/waterdrop/producer/transactions.rb#123
  def transaction?; end
  ...
  #
  # source://waterdrop//lib/waterdrop/producer/transactions.rb#140
  ...
  #
  # source://waterdrop//lib/waterdrop/producer/transactions.rb#128
  ...
  #
  # source://waterdrop//lib/waterdrop/producer/transactions.rb#192
  ...
  #
  # source://waterdrop//lib/waterdrop/producer/transactions.rb#268
  ...
  #
  # source://waterdrop//lib/waterdrop/producer/transactions.rb#183
  ...
  #
  # source://waterdrop//lib/waterdrop/producer/transactions.rb#211
...
class WaterDrop::Producer::Variant < ::SimpleDelegator
  ...
  #   settings.
  #
  # source://waterdrop//lib/waterdrop/producer/variant.rb#94
  def to_h; end
end
