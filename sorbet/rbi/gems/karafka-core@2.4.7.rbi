...
module Karafka
  class << self
    # source://karafka/2.4.14/lib/karafka.rb#118
    def boot_file; end

    # source://karafka/2.4.14/lib/karafka.rb#75
    def core_root; end

    # source://karafka/2.4.14/lib/karafka.rb#25
    def env; end

    # source://karafka/2.4.14/lib/karafka.rb#33
    def env=(environment); end

    # source://karafka/2.4.14/lib/karafka.rb#53
    def gem_root; end

    # source://karafka/2.4.14/lib/karafka.rb#38
    def logger; end

    # source://karafka/2.4.14/lib/karafka.rb#48
    def monitor; end

    # source://karafka/2.4.14/lib/karafka.rb#80
    def pro?; end

    # source://karafka/2.4.14/lib/karafka.rb#43
    def producer; end

    # source://karafka/2.4.14/lib/karafka.rb#90
    def rails?; end

    # source://karafka/2.4.14/lib/karafka.rb#137
    def refresh!; end

    # source://karafka/2.4.14/lib/karafka.rb#58
    def root; end
  end
end
...
class Karafka::Core::Contractable::Contract
  ...
  #
  # source://karafka-core//lib/karafka/core/contractable/contract.rb#82
  def call(data); end
  ...
  # @return [Boolean] true
  #
  # source://karafka-core//lib/karafka/core/contractable/contract.rb#104
  ...
  #
  # source://karafka-core//lib/karafka/core/contractable/contract.rb#175
  ...
  #
  # source://karafka-core//lib/karafka/core/contractable/contract.rb#142
  ...
  # @param errors [Array] array with errors from previous rules (if any)
  #
  # source://karafka-core//lib/karafka/core/contractable/contract.rb#120
  ...
  # @param errors [Array] array with errors from previous rules (if any)
  #
  # source://karafka-core//lib/karafka/core/contractable/contract.rb#160
  ...
  class << self
    ...
    #
    # source://karafka-core//lib/karafka/core/contractable/contract.rb#36
    def nested(path, &block); end

    # @param keys [Array<Symbol>] single or full path
    # @param block [Proc] validation rule
    #
    # source://karafka-core//lib/karafka/core/contractable/contract.rb#55
    ...
    #
    # source://karafka-core//lib/karafka/core/contractable/contract.rb#25
    def rules; end
    ...
    # @param block [Proc] validation rule
    #
    # source://karafka-core//lib/karafka/core/contractable/contract.rb#64
    ...
    #
    # source://karafka-core//lib/karafka/core/contractable/contract.rb#72
    def init_accu; end
  end
end
...
#
# source://karafka-core//lib/karafka/core/contractable/contract.rb#15
Karafka::Core::Contractable::Contract::DIG_MISS = T.let(T.unsafe(nil), Object)
...
module Karafka::Core::Helpers::Time
  ...
  #
  # source://karafka-core//lib/karafka/core/helpers/time.rb#22
  def float_now; end

  # @return [Float] current monotonic time in milliseconds
  #
  # source://karafka-core//lib/karafka/core/helpers/time.rb#11
...
class Karafka::Core::Monitoring::Monitor
  ...
  #
  # source://karafka-core//lib/karafka/core/monitoring/monitor.rb#53
  def listeners; end
...
class Karafka::Core::Monitoring::Notifications
  ...
  #
  # source://karafka-core//lib/karafka/core/monitoring/notifications.rb#32
  def available_events; end
  ...
  #
  # source://karafka-core//lib/karafka/core/monitoring/notifications.rb#49
  def clear(event_id = T.unsafe(nil)); end
  ...
  #
  # source://karafka-core//lib/karafka/core/monitoring/notifications.rb#104
  def instrument(event_id, payload = T.unsafe(nil)); end
  ...
  #
  # source://karafka-core//lib/karafka/core/monitoring/notifications.rb#39
  ...
  #
  # source://karafka-core//lib/karafka/core/monitoring/notifications.rb#72
