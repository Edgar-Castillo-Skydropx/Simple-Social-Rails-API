...
class Rdkafka::AbstractHandle < ::FFI::Struct
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/abstract_handle.rb#39
  def initialize; end

  # @return [Object] operation-specific result
  #
  # source://karafka-rdkafka//lib/rdkafka/abstract_handle.rb#103
  def create_result; end

  # @return [String] the name of the operation (e.g. "delivery")
  #
  # source://karafka-rdkafka//lib/rdkafka/abstract_handle.rb#98
  ...
  # @return [Boolean]
  #
  # source://karafka-rdkafka//lib/rdkafka/abstract_handle.rb#49
  def pending?; end

  # Allow subclasses to override
  #
  # source://karafka-rdkafka//lib/rdkafka/abstract_handle.rb#108
  def raise_error; end

  # Unlock the resources
  #
  # source://karafka-rdkafka//lib/rdkafka/abstract_handle.rb#90
  def unlock; end
  ...
  # @return [Object] Operation-specific result
  #
  # source://karafka-rdkafka//lib/rdkafka/abstract_handle.rb#65
  def wait(max_wait_timeout: T.unsafe(nil), raise_response_error: T.unsafe(nil)); end
  ...
  class << self
    ...
    #
    # source://karafka-rdkafka//lib/rdkafka/abstract_handle.rb#26
    ...
    #
    # source://karafka-rdkafka//lib/rdkafka/abstract_handle.rb#34
...
module Rdkafka::Bindings
  ...
  class << self
    ...
    # source://karafka-rdkafka//lib/rdkafka/bindings.rb#382
...
#
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#112
class Rdkafka::Bindings::ConfigResource < ::FFI::Struct; end

# source://karafka-rdkafka//lib/rdkafka/bindings.rb#193
Rdkafka::Bindings::LogCallback = T.let(T.unsafe(nil), FFI::Function)

# Message struct
#
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#63
class Rdkafka::Bindings::Message < ::FFI::Struct; end

# Extracting data from group results
#
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#547
class Rdkafka::Bindings::NativeError < ::FFI::Struct; end

# Errors
#
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#149
...
# ```
#
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#256
Rdkafka::Bindings::OAuthbearerTokenRefreshCallback = T.let(T.unsafe(nil), FFI::Function)

# Partitioner
#
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#376
...
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#526
...
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#525
Rdkafka::Bindings::RD_KAFKA_ACL_OPERATION_DESCRIBE = T.let(T.unsafe(nil), Integer)

# source://karafka-rdkafka//lib/rdkafka/bindings.rb#527
...
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#535
...
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#145
...
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#363
...
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#361
Rdkafka::Bindings::RD_KAFKA_PURGE_F_INFLIGHT = T.let(T.unsafe(nil), Integer)

# source://karafka-rdkafka//lib/rdkafka/bindings.rb#360
...
#
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#504
...
#
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#511
...
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#512
...
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#505
...
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#359
...
# source://karafka-rdkafka//lib/rdkafka/bindings.rb#357
...
module Rdkafka::Callbacks
  class << self
    ...
    #
    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#384
...
# @private
#
# source://karafka-rdkafka//lib/rdkafka/callbacks.rb#152
class Rdkafka::Callbacks::BackgroundEventCallback
  class << self
    ...
    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#286
    def process_create_acl(event_ptr); end

    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#268
    def process_create_partitions(event_ptr); end

    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#178
    def process_create_topic(event_ptr); end

    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#303
    def process_delete_acl(event_ptr); end

    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#232
    def process_delete_groups(event_ptr); end

    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#250
    def process_delete_topic(event_ptr); end

    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#325
    def process_describe_acl(event_ptr); end

    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#196
    def process_describe_configs(event_ptr); end

    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#214
...
# @private
#
# source://karafka-rdkafka//lib/rdkafka/callbacks.rb#51
class Rdkafka::Callbacks::CreateAclResult
  # @return [CreateAclResult] a new instance of CreateAclResult
  #
  # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#54
  ...
  class << self
    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#60
...
# @private
#
# source://karafka-rdkafka//lib/rdkafka/callbacks.rb#71
class Rdkafka::Callbacks::DeleteAclResult
  # @return [DeleteAclResult] a new instance of DeleteAclResult
  #
  # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#74
  def initialize(acl_result_pointer); end
  ...
  class << self
    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#87
...
# @private
#
# source://karafka-rdkafka//lib/rdkafka/callbacks.rb#344
class Rdkafka::Callbacks::DeliveryCallback
  class << self
    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#345
...
# @private
#
# source://karafka-rdkafka//lib/rdkafka/callbacks.rb#98
class Rdkafka::Callbacks::DescribeAclResult
  # @return [DescribeAclResult] a new instance of DescribeAclResult
  #
  # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#101
...
# source://karafka-rdkafka//lib/rdkafka/callbacks.rb#25
class Rdkafka::Callbacks::GroupResult
  ...
  class << self
    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#40
    def create_group_results_from_array(count, array_pointer); end
  end
end

# source://karafka-rdkafka//lib/rdkafka/callbacks.rb#133
class Rdkafka::Callbacks::IncrementalAlterConfigsResult
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#136
  def initialize(event_ptr); end
...
# @private
#
# source://karafka-rdkafka//lib/rdkafka/callbacks.rb#8
class Rdkafka::Callbacks::TopicResult
  # @return [TopicResult] a new instance of TopicResult
  #
  # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#11
  ...
  class << self
    # source://karafka-rdkafka//lib/rdkafka/callbacks.rb#17
...
class Rdkafka::Config
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/config.rb#171
  def [](key); end
  ...
  # @return [nil]
  #
  # source://karafka-rdkafka//lib/rdkafka/config.rb#162
  def []=(key, value); end
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/config.rb#273
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/config.rb#206
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/config.rb#194
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/config.rb#178
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/config.rb#240
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/config.rb#303
  def native_config(opaque = T.unsafe(nil)); end

  # source://karafka-rdkafka//lib/rdkafka/config.rb#347
...
#
# source://karafka-rdkafka//lib/rdkafka/config.rb#294
class Rdkafka::Config::ClientCreationError < ::RuntimeError; end

# Error that is returned by the underlying rdkafka error if an invalid configuration option is present.
#
# source://karafka-rdkafka//lib/rdkafka/config.rb#291
...
#
# source://karafka-rdkafka//lib/rdkafka/config.rb#297
...
class Rdkafka::Consumer
  ...
  # @return [nil]
  #
  # source://karafka-rdkafka//lib/rdkafka/consumer.rb#521
  ...
  # @private
  #
  # source://karafka-rdkafka//lib/rdkafka/consumer.rb#713
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/consumer.rb#607
  def each; end
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/consumer.rb#670
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/consumer.rb#592
  ...
  # @return [TopicPartitionList]
  #
  # source://karafka-rdkafka//lib/rdkafka/consumer.rb#484
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/consumer.rb#548
  ...
  # @return [nil]
  #
  # source://karafka-rdkafka//lib/rdkafka/consumer.rb#450
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/consumer.rb#723
...
module Rdkafka::Consumer::Headers
  class << self
    ...
    #
    # source://karafka-rdkafka//lib/rdkafka/consumer/headers.rb#16
...
class Rdkafka::Opaque
  ...
  # source://karafka-rdkafka//lib/rdkafka/config.rb#380
  def call_on_partitions_assigned(list); end

  # source://karafka-rdkafka//lib/rdkafka/config.rb#387
  def call_on_partitions_revoked(list); end

  # Returns the value of attribute consumer_rebalance_listener.
  #
  # source://karafka-rdkafka//lib/rdkafka/config.rb#374
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/config.rb#373
  def producer; end
...
class Rdkafka::Producer
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/producer.rb#452
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/producer.rb#435
  def call_delivery_callback(delivery_report, delivery_handle); end
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/producer.rb#464
...
class Rdkafka::Producer::DeliveryHandle < ::Rdkafka::AbstractHandle
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/producer/delivery_handle.rb#27
  def create_result; end
  ...
  # @return [String] the name of the operation (e.g. "delivery")
  #
  # source://karafka-rdkafka//lib/rdkafka/producer/delivery_handle.rb#22
  def operation_name; end
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/producer/delivery_handle.rb#19
  def topic; end
...
class Rdkafka::RdkafkaError < ::Rdkafka::BaseError
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/error.rb#91
  def initialize(response, message_prefix = T.unsafe(nil), broker_message: T.unsafe(nil), fatal: T.unsafe(nil), retryable: T.unsafe(nil), abortable: T.unsafe(nil), details: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://karafka-rdkafka//lib/rdkafka/error.rb#151
  def abortable?; end
  ...
  # @return [Symbol]
  #
  # source://karafka-rdkafka//lib/rdkafka/error.rb#112
  def code; end
  ...
  # @return [Hash]
  #
  # source://karafka-rdkafka//lib/rdkafka/error.rb#26
  def details; end

  # @return [Boolean]
  #
  # source://karafka-rdkafka//lib/rdkafka/error.rb#143
  def fatal?; end
  ...
  # @return [String]
  #
  # source://karafka-rdkafka//lib/rdkafka/error.rb#18
  ...
  # @return [Integer]
  #
  # source://karafka-rdkafka//lib/rdkafka/error.rb#14
  def rdkafka_response; end
  ...
  # @return [String]
  #
  # source://karafka-rdkafka//lib/rdkafka/error.rb#123
  def to_s; end

  class << self
    # source://karafka-rdkafka//lib/rdkafka/error.rb#51
    def build(response_ptr_or_code, message_prefix = T.unsafe(nil), broker_message: T.unsafe(nil)); end

    # source://karafka-rdkafka//lib/rdkafka/error.rb#29
    def build_from_c(response_ptr, message_prefix = T.unsafe(nil), broker_message: T.unsafe(nil)); end

    # source://karafka-rdkafka//lib/rdkafka/error.rb#84
...
#
# source://karafka-rdkafka//lib/rdkafka/error.rb#10
Rdkafka::RdkafkaError::EMPTY_HASH = T.let(T.unsafe(nil), Hash)

# Error with topic partition list returned by the underlying rdkafka library.
#
# source://karafka-rdkafka//lib/rdkafka/error.rb#157
class Rdkafka::RdkafkaTopicPartitionListError < ::Rdkafka::RdkafkaError
  ...
  #
  # source://karafka-rdkafka//lib/rdkafka/error.rb#162
  def initialize(response, topic_partition_list, message_prefix = T.unsafe(nil)); end

  # @return [TopicPartitionList]
  #
  # source://karafka-rdkafka//lib/rdkafka/error.rb#159
