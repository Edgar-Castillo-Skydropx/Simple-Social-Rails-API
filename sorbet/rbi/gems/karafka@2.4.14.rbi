...
class ActiveJob::QueueAdapters::KarafkaAdapter
  ...
  #
  # source://karafka//lib/active_job/queue_adapters/karafka_adapter.rb#17
  def enqueue(job); end
  ...
  #
  # source://karafka//lib/active_job/queue_adapters/karafka_adapter.rb#40
  ...
  #
  # source://karafka//lib/active_job/queue_adapters/karafka_adapter.rb#24
  ...
  #
  # source://karafka//lib/active_job/queue_adapters/karafka_adapter.rb#34
...
module Karafka
  class << self
    ...
    #
    # source://karafka//lib/karafka.rb#118
    def boot_file; end

    # @return [Pathname] path to Karafka gem root core
    #
    # source://karafka//lib/karafka.rb#75
    def core_root; end
    ...
    #
    # source://karafka//lib/karafka.rb#80
    def pro?; end
    ...
    #
    # source://karafka//lib/karafka.rb#90
    def rails?; end
    ...
    #
    # source://karafka//lib/karafka.rb#137
    def refresh!; end
...
class Karafka::ActiveJob::Dispatcher
  ...
  def dispatch_at(_job, _timestamp); end
  ...
  #
  # source://karafka//lib/karafka/active_job/dispatcher.rb#68
  def fetch_option(job, key, defaults); end

  # @param job [ActiveJob::Base] job
  # @return [Hash] json representation of the job
  #
  # source://karafka//lib/karafka/active_job/dispatcher.rb#77
...
module Karafka::Admin
  class << self
    ...
    #
    # source://karafka//lib/karafka/admin.rb#454
    ...
    #
    # source://karafka//lib/karafka/admin.rb#325
    ...
    #   and offsets
    #
    # source://karafka//lib/karafka/admin.rb#360
    ...
    #
    # source://karafka//lib/karafka/admin.rb#337
    ...
    #   Defaults to true.
    #
    # source://karafka//lib/karafka/admin.rb#292
    def rename_consumer_group(previous_name, new_name, topics, delete_previous: T.unsafe(nil)); end
    ...
    #
    # source://karafka//lib/karafka/admin.rb#509
    def with_admin; end
    ...
    #
    # source://karafka//lib/karafka/admin.rb#483
    ...
    #
    # source://karafka//lib/karafka/admin.rb#624
    def app_config; end
    ...
    #
    # source://karafka//lib/karafka/admin.rb#532
    ...
    #
    # source://karafka//lib/karafka/admin.rb#583
    ...
    #   callback referencing
    #
    # source://karafka//lib/karafka/admin.rb#545
    ...
    #
    # source://karafka//lib/karafka/admin.rb#563
...
class Karafka::App
  ...
  class << self
    ...
    #
    # source://karafka//lib/karafka/app.rb#104
    def debug!(contexts = T.unsafe(nil)); end
...
class Karafka::BaseConsumer
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#31
  def initialize; end
  ...
  # source://forwardable/1.3.3/forwardable.rb#231
  def eofed?(*args, **_arg1, &block); end
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#105
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#67
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#56
  ...
  def on_before_schedule_eofed; end

  # Can be used to run code prior to scheduling of idle execution
  #
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#140
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#154
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#85
  def on_consume; end

  # Trigger method for running on eof without messages
  #
  # source://karafka//lib/karafka/base_consumer.rb#125
  def on_eofed; end
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#147
  def on_idle; end
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#39
  def on_initialized; end

  # Trigger method for running on partition revocation.
  #
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#161
  def on_revoked; end
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#182
  def on_shutdown; end
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#28
  def producer; end
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#339
  def attempt; end
  ...
  #   each batch.
  #
  # source://karafka//lib/karafka/base_consumer.rb#202
  def initialized; end
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#248
  def pause(offset, timeout = T.unsafe(nil), manual_pause = T.unsafe(nil)); end

  # Resumes processing of the current topic partition
  #
  # source://karafka//lib/karafka/base_consumer.rb#272
  def resume; end
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#345
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#333
  def retrying?; end
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#218
  def revoked; end
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#321
  def revoked?; end
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#292
  ...
  # some teardown procedures (closing file handler, etc).
  #
  # source://karafka//lib/karafka/base_consumer.rb#222
  def shutdown; end
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#228
  def used?; end
end
...
class Karafka::Cli::Base
  ...
  class << self
    ...
    #
    # source://karafka//lib/karafka/cli/base.rb#94
    def aliases(*args); end

    # @return [Array<Class>] available commands
    #
    # source://karafka//lib/karafka/cli/base.rb#121
    def commands; end
    ...
    #   given Cli command
    #
    # source://karafka//lib/karafka/cli/base.rb#133
    def name; end

    # @return [Array<String>] names and aliases for command matching
    #
    # source://karafka//lib/karafka/cli/base.rb#138
    def names; end
    ...
    #
    # source://karafka//lib/karafka/cli/base.rb#81
    ...
    #
    # source://karafka//lib/karafka/cli/base.rb#101
...
class Karafka::Cli::Install < ::Karafka::Cli::Base
  ...
  #
  # source://karafka//lib/karafka/cli/install.rb#72
  def rails?; end
end
...
class Karafka::Cli::Server < ::Karafka::Cli::Base
  ...
  #
  # source://karafka//lib/karafka/cli/server.rb#106
  def register_exclusions; end

  # Registers things we want to include (if defined)
  #
  # source://karafka//lib/karafka/cli/server.rb#97
...
class Karafka::Cli::Topics < ::Karafka::Cli::Base
  ...
  #
  # source://karafka//lib/karafka/cli/topics.rb#33
...
# crashes
#
# source://karafka//lib/karafka/cli/topics.rb#28
Karafka::Cli::Topics::CHANGES_EXIT_CODE = T.let(T.unsafe(nil), Integer)
...
#
# source://karafka//lib/karafka/cli/topics.rb#24
Karafka::Cli::Topics::NO_CHANGES_EXIT_CODE = T.let(T.unsafe(nil), Integer)
...
class Karafka::Cli::Topics::Plan < ::Karafka::Cli::Topics::Base
  ...
  #   be altered.
  #
  # source://karafka//lib/karafka/cli/topics/plan.rb#147
  def topics_to_alter; end

  # @return [Array<Karafka::Routing::Topic>] topics that will be created
  #
  # source://karafka//lib/karafka/cli/topics/plan.rb#111
  ...
  #
  # source://karafka//lib/karafka/cli/topics/plan.rb#123
...
class Karafka::Connection::Client
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#61
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#179
  def assignment; end

  # @return [Boolean] true if our current assignment has been lost involuntarily.
  #
  # source://karafka//lib/karafka/connection/client.rb#174
  ...
  #   partition
  #
  # source://karafka//lib/karafka/connection/client.rb#99
  def batch_poll; end
  ...
  #   given partition.
  #
  # source://karafka//lib/karafka/connection/client.rb#196
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#203
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#417
  ...
  # @return [FFI::Pointer]
  #
  # source://karafka//lib/karafka/connection/client.rb#404
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#397
  def events_poll(timeout = T.unsafe(nil)); end

  # @return [String] id of the client
  #
  # source://karafka//lib/karafka/connection/client.rb#24
  def id; end
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#345
  ...
  # @return [Boolean] true if successful. False if we no longer own given partition
  #
  # source://karafka//lib/karafka/connection/client.rb#354
  def mark_as_consumed!(message, metadata = T.unsafe(nil)); end

  # @note Consumer name may change in case we regenerate it
  # @return [String] underlying consumer name
  #
  # source://karafka//lib/karafka/connection/client.rb#21
  def name; end
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#227
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#380
  def ping; end

  # Returns the value of attribute rebalance_manager.
  #
  # source://karafka//lib/karafka/connection/client.rb#13
  def rebalance_manager; end

  # Closes and resets the client completely.
  #
  # source://karafka//lib/karafka/connection/client.rb#361
  def reset; end
  ...
  # @param partition [Integer] partition
  #
  # source://karafka//lib/karafka/connection/client.rb#268
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#213
  def seek(message); end

  # Gracefully stops topic consumption.
  #
  # source://karafka//lib/karafka/connection/client.rb#297
  def stop; end
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#169
  ...
  #   belongs to
  #
  # source://karafka//lib/karafka/connection/client.rb#17
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#657
  def build_consumer; end

  # Commits the stored offsets in a sync way and closes the consumer.
  #
  # source://karafka//lib/karafka/connection/client.rb#487
  def close; end
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#439
  ...
  #   It can have the time based offset.
  #
  # source://karafka//lib/karafka/connection/client.rb#451
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#429
  def internal_store_offset(message, metadata); end

  # @return [Rdkafka::Consumer] librdkafka consumer instance
  #
  # source://karafka//lib/karafka/connection/client.rb#735
  def kafka; end
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#565
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#724
  ...
  # @return [Rdkafka::Consumer::TopicPartitionList]
  #
  # source://karafka//lib/karafka/connection/client.rb#530
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#546
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#516
  def unsubscribe; end
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#755
  def unsubscribe?; end
end
...
#
# source://karafka//lib/karafka/connection/client.rb#32
Karafka::Connection::Client::COOP_UNSUBSCRIBE_FACTOR = T.let(T.unsafe(nil), Float)

# Errors upon which we early report that something is off without retrying prior to the
# report
#
# source://karafka//lib/karafka/connection/client.rb#36
Karafka::Connection::Client::EARLY_REPORT_ERRORS = T.let(T.unsafe(nil), Array)

# How many times should we retry polling in case of a failure
#
# source://karafka//lib/karafka/connection/client.rb#27
...
class Karafka::Connection::Listener
  ...
  #
  # source://karafka//lib/karafka/connection/listener.rb#334
  ...
  # shipped.
  #
  # source://karafka//lib/karafka/connection/listener.rb#413
  ...
  #
  # source://karafka//lib/karafka/connection/listener.rb#280
  ...
  #
  # source://karafka//lib/karafka/connection/listener.rb#316
  ...
  #
  # source://karafka//lib/karafka/connection/listener.rb#273
  ...
  #
  # source://karafka//lib/karafka/connection/listener.rb#496
  def reset; end

  # Resumes processing of partitions that were paused due to an error.
  #
  # source://karafka//lib/karafka/connection/listener.rb#262
  def resume_paused_partitions; end

  # Waits for all the jobs from a given subscription group to finish before moving forward
  #
  # source://karafka//lib/karafka/connection/listener.rb#466
  def wait; end
  ...
  #
  # source://karafka//lib/karafka/connection/listener.rb#482
...
class Karafka::Connection::MessagesBuffer
  ...
  # @yieldparam true [Boolean] if eof, false otherwise
  # @yieldparam last [Float] polled at monotonic clock time
  #
  ...
  #
  # source://karafka//lib/karafka/connection/messages_buffer.rb#96
  def empty?; end
  ...
  #   otherwise false
  #
  # source://karafka//lib/karafka/connection/messages_buffer.rb#88
  ...
  #
  # source://karafka//lib/karafka/connection/messages_buffer.rb#39
  ...
  #
  # source://karafka//lib/karafka/connection/messages_buffer.rb#103
  def clear; end
end
...
class Karafka::Connection::Proxy < ::SimpleDelegator
  ...
  #
  # source://karafka//lib/karafka/connection/proxy.rb#33
  def initialize(obj); end

  # Returns the value of attribute wrapped.
  #
  # source://karafka//lib/karafka/connection/proxy.rb#28
  def __getobj__; end
  ...
  # @return [Boolean] true if offset commit worked, false if we've lost the assignment
  #
  # source://karafka//lib/karafka/connection/proxy.rb#122
  ...
  #
  # source://karafka//lib/karafka/connection/proxy.rb#86
  def committed(tpl = T.unsafe(nil)); end
  ...
  #
  # source://karafka//lib/karafka/connection/proxy.rb#152
  def lag(tpl); end
  ...
  #
  # source://karafka//lib/karafka/connection/proxy.rb#167
  ...
  #
  # source://karafka//lib/karafka/connection/proxy.rb#69
  ...
  #
  # source://karafka//lib/karafka/connection/proxy.rb#49
  ...
  # @return [Boolean] true if we could store the offset (if we still own the partition)
  #
  # source://karafka//lib/karafka/connection/proxy.rb#104
  ...
  #
  # source://karafka//lib/karafka/connection/proxy.rb#189
...
class Karafka::Connection::RawMessagesBuffer
  ...
  #
  # source://karafka//lib/karafka/connection/raw_messages_buffer.rb#23
  def initialize; end
  ...
  #
  # source://karafka//lib/karafka/connection/raw_messages_buffer.rb#116
  def clear; end
  ...
  #
  # source://karafka//lib/karafka/connection/raw_messages_buffer.rb#78
  ...
  # @yieldparam has [Boolean] polling of this partition reach eof
  #
  # source://karafka//lib/karafka/connection/raw_messages_buffer.rb#66
  def each; end
  ...
  #
  # source://karafka//lib/karafka/connection/raw_messages_buffer.rb#51
  def eof(topic, partition); end

  # @return [Float] last polling time in milliseconds (monotonic)
  #
  # source://karafka//lib/karafka/connection/raw_messages_buffer.rb#20
  def last_polled_at; end

  # Marks the last polling time that can be accessed via `#last_polled_at`
  #
  # source://karafka//lib/karafka/connection/raw_messages_buffer.rb#56
  def polled; end

  # Returns the value of attribute size.
  #
  # source://karafka//lib/karafka/connection/raw_messages_buffer.rb#17
  def size; end
  ...
  #
  # source://karafka//lib/karafka/connection/raw_messages_buffer.rb#95
  def uniq!; end
  ...
  #
  # source://karafka//lib/karafka/connection/raw_messages_buffer.rb#124
  def recount!; end
end
...
class Karafka::Contracts::ConsumerGroup < ::Karafka::Contracts::Base
  class << self
    ...
    #
    # source://karafka//lib/karafka/contracts/consumer_group.rb#75
...
#
# source://karafka//lib/karafka/contracts/routing.rb#6
class Karafka::Contracts::Routing < ::Karafka::Contracts::Base; end
...
#
# source://karafka//lib/karafka/embedded.rb#10
module Karafka::Embedded
  class << self
    ...
    #
    # source://karafka//lib/karafka/embedded.rb#76
    def quiet; end
    ...
    #
    # source://karafka//lib/karafka/embedded.rb#19
    def start; end
    ...
    #
    # source://karafka//lib/karafka/embedded.rb#42
    def stop; end
  end
end
...
#
# source://karafka//lib/karafka/errors.rb#90
...
#
# source://karafka//lib/karafka/errors.rb#102
...
module Karafka::Helpers::Async
  ...
  #
  # source://karafka//lib/karafka/helpers/async.rb#30
  def alive?; end
  ...
  #
  # source://karafka//lib/karafka/helpers/async.rb#40
  def async_call(thread_name); end
...
class Karafka::Helpers::ConfigImporter < ::Module
  ...
  #
  # source://karafka//lib/karafka/helpers/config_importer.rb#30
...
class Karafka::Instrumentation::LoggerListener
  ...
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#379
  def debug(*args); end
  ...
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#187
  def on_app_quiet(_event); end

  # @param _event [Karafka::Core::Monitoring::Event] event details including payload
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#182
  ...
  # @param _event [Karafka::Core::Monitoring::Event] event details including payload
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#201
  ...
  # @param _event [Karafka::Core::Monitoring::Event] event details including payload
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#194
  ...
  # @param event [Karafka::Core::Monitoring::Event] event details including payload
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#133
  def on_consumer_consuming_seek(event); end

  # Logs info when we have dispatched a message the the DLQ
  #
  # @param event [Karafka::Core::Monitoring::Event] event details including payload
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#208
  ...
  # @param event [Karafka::Core::Monitoring::Event] event details including payload
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#287
  ...
  # @param event [Karafka::Core::Monitoring::Event] event details including payload
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#226
  ...
  # @param event [Karafka::Core::Monitoring::Event] event details including payload
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#149
  def on_process_notice_signal(event); end

  # @param event [Karafka::Core::Monitoring::Event] event details including payload
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#269
  def on_swarm_manager_before_fork(event); end

  # @param event [Karafka::Core::Monitoring::Event] event details including payload
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#279
  def on_swarm_manager_control(event); end

  # @param event [Karafka::Core::Monitoring::Event] event details including payload
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#257
  def on_swarm_manager_stopping(event); end

  # @param event [Karafka::Core::Monitoring::Event] event details including payload
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#263
  def on_swarm_manager_terminating(event); end

  # @param _event [Karafka::Core::Monitoring::Event] event details including payload
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#274
  ...
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#387
  def log_polling?; end
end
...
class Karafka::Instrumentation::Notifications < ::Karafka::Core::Monitoring::Notifications
  ...
  #
  # source://karafka//lib/karafka/instrumentation/notifications.rb#111
  def initialize; end
end
...
class Karafka::Messages::Message
  ...
  #
  # source://karafka//lib/karafka/messages/message.rb#25
  def initialize(raw_payload, metadata); end

  # @return [Boolean] did we deserialize payload already
  #
  # source://karafka//lib/karafka/messages/message.rb#44
  ...
  #
  # source://karafka//lib/karafka/messages/message.rb#15
  def metadata; end
  ...
  #
  # source://karafka//lib/karafka/messages/message.rb#33
  def payload; end
  ...
  #
  # source://karafka//lib/karafka/messages/message.rb#18
  def raw_payload; end
  ...
  class << self
    # source://karafka//lib/karafka/helpers/config_importer.rb#35
    def parser; end
  end
end
...
class Karafka::Processing::Coordinator
  ...
  #
  # source://karafka//lib/karafka/processing/coordinator.rb#30
  ...
  #
  # source://karafka//lib/karafka/processing/coordinator.rb#195
  ...
  #
  # source://karafka//lib/karafka/processing/coordinator.rb#128
  def failure!(consumer, error); end

  # @return [Boolean] true if any of work we were running failed
  #
  # source://karafka//lib/karafka/processing/coordinator.rb#136
  def failure?; end
  ...
  #
  # source://karafka//lib/karafka/processing/coordinator.rb#167
  def marked?; end
  ...
  #
  # source://karafka//lib/karafka/processing/coordinator.rb#149
  def revoke; end

  # @return [Boolean] is the partition we are processing revoked or not
  #
  # source://karafka//lib/karafka/processing/coordinator.rb#154
  def revoked?; end
  ...
  #
  # source://karafka//lib/karafka/processing/coordinator.rb#50
  ...
  # @return [Boolean]
  #
  # source://karafka//lib/karafka/processing/coordinator.rb#111
  def success?; end
  ...
  #
  # source://karafka//lib/karafka/processing/coordinator.rb#210
...
class Karafka::Processing::Executor
  ...
  #
  # source://karafka//lib/karafka/processing/executor.rb#120
  def before_schedule_revoked; end

  # Runs code needed before shutdown job is scheduled
  #
  # source://karafka//lib/karafka/processing/executor.rb#141
  ...
  #
  # source://karafka//lib/karafka/processing/executor.rb#115
  def eofed; end
  ...
  #   consumer instance.
  #
  # source://karafka//lib/karafka/processing/executor.rb#136
  def revoked; end
  ...
  #   work is done.
  #
  # source://karafka//lib/karafka/processing/executor.rb#150
  def shutdown; end
  ...
  #
  # source://karafka//lib/karafka/processing/executor.rb#159
  def consumer; end
  ...
  #
  # source://karafka//lib/karafka/processing/executor.rb#200
...
#
# source://karafka//lib/karafka/processing/jobs/eofed.rb#7
class Karafka::Processing::Jobs::Eofed < ::Karafka::Processing::Jobs::Base
  # @param executor [Karafka::Processing::Executor] executor that is suppose to run the job
  # @return [Eofed]
  #
  # source://karafka//lib/karafka/processing/jobs/eofed.rb#10
  def initialize(executor); end

  # Runs code prior to scheduling this eofed job
  #
  # source://karafka//lib/karafka/processing/jobs/eofed.rb#16
  def before_schedule; end

  # Runs the eofed job via an executor.
  #
  # source://karafka//lib/karafka/processing/jobs/eofed.rb#21
  def call; end
end
...
class Karafka::Processing::JobsBuilder
  ...
  #
  # source://karafka//lib/karafka/processing/jobs_builder.rb#29
...
class Karafka::Processing::Schedulers::Default
  ...
  #
  # source://karafka//lib/karafka/processing/schedulers/default.rb#37
  def on_clear(_group_id); end

  # This scheduler does not have anything to manage as it is a pass through and has no state
  #
  # source://karafka//lib/karafka/processing/schedulers/default.rb#30
  def on_manage; end
  ...
  #
  # source://karafka//lib/karafka/processing/schedulers/default.rb#17
  def on_schedule_eofed(jobs_array); end
...
module Karafka::Processing::Strategies::Default
  ...
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#94
  def commit_offsets(async: T.unsafe(nil)); end
  ...
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#109
  def commit_offsets!; end
  ...
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#140
  def handle_after_consume; end

  # Increment number of attempts
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#114
  def handle_before_consume; end

  # source://karafka//lib/karafka/processing/strategies/default.rb#26
  def handle_before_schedule_consume; end

  # source://karafka//lib/karafka/processing/strategies/default.rb#26
  def handle_before_schedule_eofed; end
  ...
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#119
  def handle_consume; end

  # Runs the consumer `#eofed` method with reporting
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#166
  def handle_eofed; end

  # Code that should run on idle runs without messages available
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#159
  def handle_idle; end
  ...
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#37
  def handle_initialized; end
  ...
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#178
  def handle_revoked; end

  # Runs the shutdown code
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#192
  def handle_shutdown; end
  ...
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#54
  ...
  #   False indicates that we were not able and that we have lost the partition.
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#73
  def mark_as_consumed!(message); end
end
...
module Karafka::Processing::Strategies::Dlq
  ...
  # @private
  #
  # source://karafka//lib/karafka/processing/strategies/dlq.rb#112
  ...
  #
  # source://karafka//lib/karafka/processing/strategies/dlq.rb#96
  ...
  #   with it.
  #
  # source://karafka//lib/karafka/processing/strategies/dlq.rb#131
  def mark_after_dispatch?; end
  ...
  #
  # source://karafka//lib/karafka/processing/strategies/dlq.rb#139
...
module Karafka::Processing::Strategies::DlqMom
  ...
  #   with it.
  #
  # source://karafka//lib/karafka/processing/strategies/dlq_mom.rb#60
  def mark_after_dispatch?; end
end
...
class Karafka::Processing::Worker
  ...
  # @return [Worker]
  #
  # source://karafka//lib/karafka/processing/worker.rb#30
  def initialize(jobs_queue); end

  # @return [String] id of this worker
  #
  # source://karafka//lib/karafka/processing/worker.rb#26
  def id; end
  ...
  # source://karafka//lib/karafka/helpers/config_importer.rb#22
  def worker_job_call_wrapper; end
  ...
  #
  # source://karafka//lib/karafka/processing/worker.rb#40
  def call; end
  ...
  #
  # source://karafka//lib/karafka/processing/worker.rb#50
  def process; end
end
...
class Karafka::Routing::Builder < ::Array
  ...
  #
  # source://karafka//lib/karafka/routing/builder.rb#73
  def active; end

  # Clears the builder and the draws memory
  #
  # source://karafka//lib/karafka/routing/builder.rb#78
  def clear; end
  ...
  #
  # source://karafka//lib/karafka/routing/builder.rb#88
  ...
  #
  # source://karafka//lib/karafka/routing/builder.rb#105
  ...
  #
  # source://karafka//lib/karafka/routing/builder.rb#122
  ...
  #
  # source://karafka//lib/karafka/routing/builder.rb#142
...
class Karafka::Routing::ConsumerGroup
  ...
  #
  # source://karafka//lib/karafka/routing/consumer_group.rb#29
  def initialize(name); end

  # @return [Boolean] true if this consumer group should be active in our current process
  #
  # source://karafka//lib/karafka/routing/consumer_group.rb#40
  def active?; end
  ...
  #
  # source://karafka//lib/karafka/routing/consumer_group.rb#66
  def subscription_group=(name = T.unsafe(nil), &block); end

  # @return [Array<Routing::SubscriptionGroup>] all the subscription groups build based on
  #   the consumer group topics
  #
  # source://karafka//lib/karafka/routing/consumer_group.rb#80
  def subscription_groups; end

  # source://karafka//lib/karafka/helpers/config_importer.rb#22
  def subscription_groups_builder; end
  ...
  #
  # source://karafka//lib/karafka/routing/consumer_group.rb#87
  def to_h; end
  ...
  #
  # source://karafka//lib/karafka/routing/consumer_group.rb#48
...
class Karafka::Routing::Features::DeadLetterQueue::Config < ::Struct
  ...
  #
  # @return [Object] the current value of mark_after_dispatch
  def mark_after_dispatch; end

  # Sets the attribute mark_after_dispatch
  #
  # @param value [Object] the value to set the attribute mark_after_dispatch to.
  # @return [Object] the newly set value
  def mark_after_dispatch=(_); end
...
module Karafka::Routing::Features::DeadLetterQueue::Topic
  ...
  #
  # source://karafka//lib/karafka/routing/features/dead_letter_queue/topic.rb#29
  def dead_letter_queue(max_retries: T.unsafe(nil), topic: T.unsafe(nil), independent: T.unsafe(nil), transactional: T.unsafe(nil), dispatch_method: T.unsafe(nil), marking_method: T.unsafe(nil), mark_after_dispatch: T.unsafe(nil)); end
  ...
  #
  # source://karafka//lib/karafka/routing/features/dead_letter_queue/topic.rb#56
  def to_h; end
end
...
#
# source://karafka//lib/karafka/routing/features/eofed.rb#10
class Karafka::Routing::Features::Eofed < ::Karafka::Routing::Features::Base; end

# Config of this feature
#
# source://karafka//lib/karafka/routing/features/eofed/config.rb#8
class Karafka::Routing::Features::Eofed::Config < ::Struct
  # Returns the value of attribute active
  #
  # @return [Object] the current value of active
  def active; end
...
#
# source://karafka//lib/karafka.rb#0
module Karafka::Routing::Features::Eofed::Contracts; end

# Contract for eofed topic setup
#
# source://karafka//lib/karafka/routing/features/eofed/contracts/topic.rb#10
class Karafka::Routing::Features::Eofed::Contracts::Topic < ::Karafka::Contracts::Base; end

# Routing topic eofed API
#
# source://karafka//lib/karafka/routing/features/eofed/topic.rb#8
module Karafka::Routing::Features::Eofed::Topic
  # @param active [Boolean] should the `#eofed` job run on eof
  #
  # source://karafka//lib/karafka/routing/features/eofed/topic.rb#10
  def eofed(active = T.unsafe(nil)); end

  # @return [Boolean] Are `#eofed` jobs active
  #
  # source://karafka//lib/karafka/routing/features/eofed/topic.rb#17
  def eofed?; end

  # @return [Hash] topic setup hash
  #
  # source://karafka//lib/karafka/routing/features/eofed/topic.rb#22
  def to_h; end
end
...
class Karafka::Routing::SubscriptionGroup
  ...
  #
  # source://karafka//lib/karafka/routing/subscription_group.rb#146
  def inject_client_id(kafka); end

  # Injects (if needed) defaults
  #
  # @param kafka [Hash] kafka level config
  #
  # source://karafka//lib/karafka/routing/subscription_group.rb#139
  def inject_defaults(kafka); end
  ...
  # @param kafka [Hash] kafka level config
  #
  # source://karafka//lib/karafka/routing/subscription_group.rb#172
...
class Karafka::Routing::Topic
  ...
  include ::Karafka::Routing::Features::Eofed::Topic
  ...
  #
  # source://karafka//lib/karafka/routing/topic.rb#97
  def active(active); end

  # @return [Boolean] should this topic be in use
  #
  # source://karafka//lib/karafka/routing/topic.rb#120
  def active?; end

  # @return [Class] consumer class that we should use
  #
  # source://karafka//lib/karafka/routing/topic.rb#77
  def consumer; end
  ...
  # @return [Class] consumer class that we should use
  #
  # source://karafka//lib/karafka/routing/topic.rb#115
  ...
  #
  # source://karafka//lib/karafka/routing/topic.rb#65
  def kafka=(settings = T.unsafe(nil)); end
  ...
  #
  # source://karafka//lib/karafka/routing/topic.rb#72
...
class Karafka::Runner
  ...
  #
  # source://karafka//lib/karafka/runner.rb#14
  def call; end
...
class Karafka::Server
  class << self
    ...
    #
    # source://karafka//lib/karafka/server.rb#31
    ...
    #
    # source://karafka//lib/karafka/server.rb#31
    def execution_mode=(_arg0); end

    # Jobs queue
    #
    # source://karafka//lib/karafka/server.rb#20
    def jobs_queue; end
    ...
    #
    # source://karafka//lib/karafka/server.rb#167
    def quiet; end

    # Method which runs app
    #
    # source://karafka//lib/karafka/server.rb#34
    def run; end
    ...
    #
    # source://karafka//lib/karafka/server.rb#81
    def start; end
    ...
    #
    # source://karafka//lib/karafka/server.rb#91
    def stop; end
    ...
    #
    # source://karafka//lib/karafka/server.rb#176
    def config; end

    # @return [Karafka::Process] process wrapper instance used to catch system signal calls
    #
    # source://karafka//lib/karafka/server.rb#181
    def process; end
  end
end
...
Karafka::Server::FORCEFUL_SHUTDOWN_WAIT = T.let(T.unsafe(nil), Integer)
...
module Karafka::Setup::AttributesMap
  class << self
    ...
    #
    # source://karafka//lib/karafka/setup/attributes_map.rb#310
    ...
    #   that is sorted.
    #
    # source://karafka//lib/karafka/setup/attributes_map.rb#326
    def generate; end
    ...
    #
    # source://karafka//lib/karafka/setup/attributes_map.rb#317
...
#
# source://karafka//lib/karafka/setup/attributes_map.rb#157
Karafka::Setup::AttributesMap::PRODUCER = T.let(T.unsafe(nil), Array)

# Location of the file with rdkafka settings list
#
# source://karafka//lib/karafka/setup/attributes_map.rb#297
...
class Karafka::Setup::Config
  ...
  class << self
    ...
    #
    # source://karafka//lib/karafka/setup/config.rb#323
    def setup(&block); end
    ...
    #
    # source://karafka//lib/karafka/setup/config.rb#361
...
#
# source://karafka//lib/karafka/setup/defaults_injector.rb#8
module Karafka::Setup::DefaultsInjector
  class << self
    ...
    #
    # source://karafka//lib/karafka/setup/defaults_injector.rb#46
    def consumer(kafka_config); end
  end
end

# Defaults for kafka settings, that will be overwritten only if not present already
#
# source://karafka//lib/karafka/setup/defaults_injector.rb#10
Karafka::Setup::DefaultsInjector::CONSUMER_KAFKA_DEFAULTS = T.let(T.unsafe(nil), Hash)

# Contains settings that should not be used in production but make life easier in dev
#
# source://karafka//lib/karafka/setup/defaults_injector.rb#27
Karafka::Setup::DefaultsInjector::CONSUMER_KAFKA_DEV_DEFAULTS = T.let(T.unsafe(nil), Hash)
...
class Karafka::Swarm::Node
  ...
  #
  # source://karafka//lib/karafka/swarm/node.rb#118
  def alive?; end

  # Removes the dead process from the processes table
  #
  # source://karafka//lib/karafka/swarm/node.rb#153
  def cleanup; end
  ...
  # @note Child API
  #
  # source://karafka//lib/karafka/swarm/node.rb#85
  def healthy; end
  ...
  #
  # source://karafka//lib/karafka/swarm/node.rb#124
  def orphaned?; end
  ...
  # @note Parent API
  #
  # source://karafka//lib/karafka/swarm/node.rb#136
  def quiet; end
  ...
  # @param signal [String]
  #
  # source://karafka//lib/karafka/swarm/node.rb#148
  def signal(signal); end
  ...
  #
  # source://karafka//lib/karafka/swarm/node.rb#106
  def status; end
  ...
  # @note Parent API
  #
  # source://karafka//lib/karafka/swarm/node.rb#130
  def stop; end
  ...
  # @note Parent API
  #
  # source://karafka//lib/karafka/swarm/node.rb#142
  def terminate; end
  ...
  #
  # source://karafka//lib/karafka/swarm/node.rb#95
  ...
  #
  # source://karafka//lib/karafka/swarm/node.rb#162
  def read; end
  ...
  #
  # source://karafka//lib/karafka/swarm/node.rb#172
...
class Karafka::Swarm::Supervisor
  ...
  #
  # source://karafka//lib/karafka/swarm/supervisor.rb#37
  def initialize; end
  ...
  #
  # source://karafka//lib/karafka/swarm/supervisor.rb#43
  def run; end
  ...
  #
  # source://karafka//lib/karafka/swarm/supervisor.rb#188
  def control; end
  ...
  #
  # source://karafka//lib/karafka/swarm/supervisor.rb#101
  def lock; end

  # Moves all the nodes and itself to the quiet state
  #
  # source://karafka//lib/karafka/swarm/supervisor.rb#171
  def quiet; end
  ...
  # @param signal [String]
  #
  # source://karafka//lib/karafka/swarm/supervisor.rb#203
  def signal(signal); end
  ...
  #
  # source://karafka//lib/karafka/swarm/supervisor.rb#113
  def stop; end

  # Frees the lock on events that could require nodes control
  #
  # source://karafka//lib/karafka/swarm/supervisor.rb#106
  def unlock; end
end
...
#
# source://karafka//lib/karafka/swarm/supervisor.rb#33
