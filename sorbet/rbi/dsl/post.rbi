...
class Post
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def saved_change_to_task_date; end
    ...
    sig { params(value: T.nilable(::String)).returns(T.nilable(::String)) }
    def task_date=(value); end

    sig { returns(T::Boolean) }
    def task_date?; end

    sig { returns(T.nilable(::String)) }
    def task_date_before_last_save; end

    sig { returns(T.untyped) }
    def task_date_before_type_cast; end

    sig { returns(T::Boolean) }
    def task_date_came_from_user?; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def task_date_change; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def task_date_change_to_be_saved; end

    sig { params(from: T.nilable(::String), to: T.nilable(::String)).returns(T::Boolean) }
    def task_date_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def task_date_in_database; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def task_date_previous_change; end

    sig { params(from: T.nilable(::String), to: T.nilable(::String)).returns(T::Boolean) }
    def task_date_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def task_date_previously_was; end

    sig { returns(T.nilable(::String)) }
    def task_date_was; end

    sig { void }
    def task_date_will_change!; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_task_date?; end
